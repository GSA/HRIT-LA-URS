...
namespace lmsextreg.Authorization
{
    public class CanAccessProfileLinkHandler : AuthorizationHandler<CanAccessProfileLink>
    {
                                                        ...
                                                        CanAccessProfileLink requirement)
        {
            ...
            // _logger.LogInformation("[CanAccessProfileLinkHandler] - (" + userName + ")(isSignedInn)........: " + isSignedIn);
            // _logger.LogInformation("[CanAccessProfileLinkHandler] - (" + userName + ")isTwoFactorEnabled).: " + isTwoFactorEnabled);
            // _logger.LogInformation("[CanAccessProfileLinkHandler] - (" + userName + ")isStudentOrApprover.: " + isStudentOrApprover);
